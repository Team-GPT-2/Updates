...
def main(args_eval, plotter, resume_preempt=False):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if rank == 0:
            csv_logger.log(epoch + 1, 0.0, val_acc)  # Using 0.0 as placeholder for loss
            # OR if you want to use train_acc as the "loss" column:
